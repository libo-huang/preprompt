...
def get_args_parser(subparsers):
    subparsers.add_argument('--batch-size', default=24, type=int, help='Batch size per device')   # set
    subparsers.add_argument('--epochs', default=5, type=int)   # set

    # Model parameters
    subparsers.add_argument('--original_model', default='vit_base_patch16_224', type=str, metavar='OMODEL',
                            help='Name of original model to train')   # set
    subparsers.add_argument('--model', default='vit_base_patch16_224', type=str, metavar='MODEL',
                            help='Name of model to train')   # set
    ...
    subparsers.add_argument('--sched', default='step', type=str, metavar='SCHEDULER',
                            help='LR scheduler (default: "constant"')   # set
    subparsers.add_argument('--lr', type=float, default=0.03, metavar='LR', help='learning rate (default: 0.03)')   # set
    ...
    # Data parameters
    subparsers.add_argument('--data-path', default='/local_datasets/', type=str, help='dataset path')   # set
    ...
    subparsers.add_argument('--output_dir', default='./output', help='path where to save, empty for no saving')   # set
    subparsers.add_argument('--device', default='cuda', help='device to use for training / testing')
    subparsers.add_argument('--seed', default=42, type=int)   # set
    ...
    # ablation parameters
    subparsers.add_argument('--no_mean_tii', action='store_true')
    subparsers.add_argument('--no_mean_preprompt', action='store_true')
